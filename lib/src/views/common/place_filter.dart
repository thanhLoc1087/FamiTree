...
class _PlaceFilterState extends State<PlaceFilter> {
  ...
  @override
  void didUpdateWidget(covariant PlaceFilter oldWidget) {
  ...
  Widget _buildOption(Iterable<Place> options) {
    return Padding(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (newContext, index) {
                  ...
                  return InkResponse(
                    onTap: () {
                      focusNode.unfocus();
                      controller.text = option.address;
