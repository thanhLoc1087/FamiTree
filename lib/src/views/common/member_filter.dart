...
class MemberFilter extends StatefulWidget {
  ...
  @override
  State<MemberFilter> createState() => _MemberFilterState();
}
...
class _MemberFilterState extends State<MemberFilter> {
  ...
  @override
  void didUpdateWidget(covariant MemberFilter oldWidget) {
  ...
  Widget _buildOption(Iterable<Member> options) {
    return Padding(
