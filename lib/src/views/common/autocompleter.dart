...
/// The type of the [MyRawAutocomplete] callback which computes the list of
/// optional completions for the widget's field, based on the text the user has
/// entered so far.
///
/// See also:
///
///   * [MyRawAutocomplete.optionsBuilder], which is of this type.
typedef AutocompleteOptionsBuilder<T extends Object> = Iterable<T> Function(
    TextEditingValue textEditingValue);

/// The type of the callback used by the [MyRawAutocomplete] widget to indicate
/// that the user has selected an option.
///
/// See also:
///
///   * [MyRawAutocomplete.onSelected], which is of this type.
typedef AutocompleteOnSelected<T extends Object> = void Function(T option);

/// The type of the [MyRawAutocomplete] callback which returns a [Widget] that
...
/// See also:
///
///   * [MyRawAutocomplete.optionsViewBuilder], which is of this type.
...
/// See also:
///
///   * [MyRawAutocomplete.fieldViewBuilder], which is of this type.
...
/// The type of the [MyRawAutocomplete] callback that converts an option value to
/// a string which can be displayed in the widget's options menu.
///
/// See also:
///
///   * [MyRawAutocomplete.displayStringForOption], which is of this type.
...
class MyRawAutocomplete<T extends Object> extends StatefulWidget {
  ...
  /// place in the widget tree as [MyRawAutocomplete].
  ///
  ...
  static void onFieldSubmitted<T extends Object>(GlobalKey key) {
    final _MyRawAutocompleteState<T> rawAutocomplete =
        key.currentState! as _MyRawAutocompleteState<T>;
  ...
  @override
  State<MyRawAutocomplete<T>> createState() => _MyRawAutocompleteState<T>();
}

class _MyRawAutocompleteState<T extends Object>
    extends State<MyRawAutocomplete<T>> {
      ...
      _floatingOptions = OverlayEntry(
        builder: (BuildContext context) {
          return CompositedTransformFollower(
            ...
            targetAnchor: widget.dropdownDown == true ? Alignment.bottomLeft : Alignment.topLeft,
            followerAnchor: widget.dropdownDown == true ? Alignment.topLeft : Alignment.bottomLeft,
  ...
  @override
  void didUpdateWidget(MyRawAutocomplete<T> oldWidget) {
