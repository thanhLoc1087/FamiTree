...
class DeathCauseFilter extends StatefulWidget {
  final String initText;
  final String? errorText;
  final List<CauseOfDeath> allValues;
  final Function(CauseOfDeath)? onSelected;
  final Function(String)? onChanged;
  final Function(String)? onFieldSubmitted;
  final double? width;

  const DeathCauseFilter({
    super.key,
    this.initText = "",
    this.errorText,
  ...
  @override
  State<DeathCauseFilter> createState() => _DeathCauseFilterState();
}

class _DeathCauseFilterState extends State<DeathCauseFilter> {
  ...
  @override
  void didUpdateWidget(covariant DeathCauseFilter oldWidget) {
  ...
  Widget _buildOption(Iterable<CauseOfDeath> options) {
    return Padding(
