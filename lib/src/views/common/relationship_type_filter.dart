...
class RelationshipTypeFilter extends StatefulWidget {
  final String initText;
  final String? errorText;
  final List<RelationshipType> allValues;
  ...
  @override
  State<RelationshipTypeFilter> createState() => _RelationshipTypeFilterState();
}

class _RelationshipTypeFilterState extends State<RelationshipTypeFilter> {
  ...
  @override
  void didUpdateWidget(covariant RelationshipTypeFilter oldWidget) {
  ...
  Widget _buildTextField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: 'Choose RelationshipType',
  ...
  Widget _buildOption(Iterable<RelationshipType> options) {
    return Padding(
