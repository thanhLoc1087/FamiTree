...
class AchievementTypeFilter extends StatefulWidget {
  final String initText;
  final String? errorText;
  final List<AchievementType> allValues;
  final Function(AchievementType)? onSelected;
  ...
  @override
  State<AchievementTypeFilter> createState() => _AchievementTypeFilterState();
}

class _AchievementTypeFilterState extends State<AchievementTypeFilter> {
  ...
  @override
  void didUpdateWidget(covariant AchievementTypeFilter oldWidget) {
  ...
  Widget _buildTextField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintText: 'Choose AchievementType',
  ...
  Widget _buildOption(Iterable<AchievementType> options) {
    return Padding(
