...
class DialogUpdateJob extends StatefulWidget {
  const DialogUpdateJob({
    super.key,
    this.job,
    required this.list,
  });
  ...
  @override
  State<DialogUpdateJob> createState() => _DialogUpdateJobState();
}

class _DialogUpdateJobState extends State<DialogUpdateJob> {
