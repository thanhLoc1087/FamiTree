...
class DialogUpdateDeathCause extends StatefulWidget {
  const DialogUpdateDeathCause({
    super.key,
    this.item,
    required this.list,
  });

  final List<CauseOfDeath> list;
  final CauseOfDeath? item;

  @override
  State<DialogUpdateDeathCause> createState() => _DialogUpdateDeathCauseState();
}

class _DialogUpdateDeathCauseState extends State<DialogUpdateDeathCause> {
